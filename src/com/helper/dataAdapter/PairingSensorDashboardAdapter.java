...
public class PairingSensorDashboardAdapter extends ArrayAdapter<Sensor> {
	...
	public PairingSensorDashboardAdapter(Context context, int resource, Activity context2, ArrayList<Sensor> sensorList) {
		super(context, resource);
		context = context2;
		this.sensorList = sensorList;
	}
	
	public PairingSensorDashboardAdapter(Activity context, ArrayList<Sensor> plugList) 
	{
		super(context, R.layout.custom_sensor_homedashboard_display, plugList); 
	...
	public View getView(final int position, View convertView, ViewGroup parent)
	{
		...
		if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.custom_sensor_homedashboard_display, null);  
